...
export function AutoSaveToggle() {
  ...
  const { autoSave, autoSaveFilePath, setAutoSave, setAutoSaveFilePath } = useSettingsStore();

  const handleToggle = useCallback(async () => {
    if (!isTauri) {
      alert('Auto-save is only available in the desktop app');
      return;
    }
  ...
  }, [autoSave, autoSaveFilePath, setAutoSave, setAutoSaveFilePath, isTauri]);
